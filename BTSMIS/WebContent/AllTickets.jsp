                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td><%=it.getCpIndex() %></td>
                                        <td>  <a href="#" data-toggle="modal" data-target="#myModal" class="glyphicon glyphicon-edit" title="Remember to copy reference id before click!"> <%=it.getDowntime() %> </a></td>
                                       
                                        <td><%=it.getStatus()%></td>
                                         
                                        <td><a href="CloseTicketController?referenceId=<%=it.getReferenceId()%>">Close</a></td>
