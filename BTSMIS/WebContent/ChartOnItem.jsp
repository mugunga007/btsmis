...
//String qid = request.getParameter("question");
  ...
  while (rs.next()) {
            ...
            dataSet.setValue(rs.getInt(1), rs.getString(2), rs.getString(4));

            TITLE = "Report on issued "+rs.getString(3);
        ...
        final CategoryAxis3D categoryAxis = new CategoryAxis3D("QUANTITY REQUESTED");
        final ValueAxis valueAxis = new NumberAxis3D("QUANTITY ISSUED");
