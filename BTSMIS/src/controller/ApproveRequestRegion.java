...
/**
 * Servlet implementation class ApproveRequestRegion
 */
public class ApproveRequestRegion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApproveRequestRegion() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String emailReceiver = um.getOperationsManager().getEmail();
		int requestId = Integer.parseInt(request.getParameter("requestId"));
		RequestModel rm = new RequestModel();
		rm.approveRequestRegion(requestId);
		...
		response.sendRedirect("RequestRegion.jsp"); 
