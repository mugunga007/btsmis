...
//String qid = request.getParameter("question");
      ...
      //  String k = "SELECT r.quantity,r.deliveredQuantity,r.requestDate FROM request r";
        String k = "SELECT SUM(ah.downtime),ah.ticketId,ar.btsId,r.rname from accessHandling ah,accessRequest ar,bts bt,region r WHERE r.regionId='"+regionId+"' and ah.ticketId=ar.requestId and r.regionId=bt.regionId and bt.btsId=ar.btsId GROUP BY 3";
        PreparedStatement ps = kon.prepareStatement(k);
        ResultSet rs = ps.executeQuery();
  while (rs.next()) {

            dataSet.setValue(rs.getInt(1), rs.getString(1), rs.getString(3));

            TITLE = "Downtime in  "+rs.getString(4)+" region";
