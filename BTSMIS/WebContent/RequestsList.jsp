...
List<Request> list = rm.getRequestSummary();
for(Request it: list){
%>
...
<%
ItemUnit in = new ItemUnit();
int itu = Integer.parseInt(itm.getItem(it.getItemId()).getUnits());
in = iu.getItemUnit(itu);
%>
<td><%=it.getQuantity()%> <%=in.getName() %>(s)</td>
<td><%=it.getDumQuantity() %></td>
<td><a href="DetailedRequestList.jsp?itemId=<%=it.getItemId() %>" class="btn btn-primary"><span class="glyphicon glyphicon-list"> </span> Show All</a></td>
