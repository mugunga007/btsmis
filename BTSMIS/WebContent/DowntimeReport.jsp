               ...
               <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                         <i class="fa fa-dashboard text-success"></i>    <small>Downtime caused by <%=reason%></small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                List<TicketHandlingReports>k=th.ticketHandlingByMonth(reason);
...
<a target="_blank" href="ChartOnDowntime.jsp?reason=<%=reason%>" class="btn btn-link glyphicon glyphicon-link" >Click to view it on graph</a>
                                                      </div>
                            </div>
                        </div>
