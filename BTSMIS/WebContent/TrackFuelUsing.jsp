               ...
               <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                         <i class="fa fa-dashboard text-success"></i>    <small>Fuel Tracking</small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                List<ItemReporting>k=it.fuelTracking(userId);
                                             
          for(ItemReporting ws:k){
                                            ...
                                            <tr>
                                                <td><%=i%></td>
                                                <td><%=ws.getDate()%></td>
                                                <td><%=ws.getAddedQuantity() %></td>
                                                <td><%=ws.getCurrentQuantity()%></td>
                                                <td><%=ws.getUsedQuantity()%></td>
                                                <td><%=ws.getRunningHours() %></td>
                                               <td><a class="btn btn-default" target="_blank" href="mapTest.jsp?lati=<%=ws.getLatitude()%>&lon=<%=ws.getLongitude() %>"><i class="fa fa-list-ul"></i> View</a></td>
