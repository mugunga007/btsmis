...
<a href="InStockList.jsp" class="active-menu"><i class="fa fa-shopping-cart"></i> Available Items (<%=im.getAvailableItems().size() %>)</a>                    
  ...
  <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           <i class="fa fa-bar-chart text-success"></i>  <small>Items Quantity</small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
...
List<Item> list = im.getAvailableItems();
for(Item it: list){
%>
                        ...
                        <tr>
                           <td><%=it.getItemName()%></td>
                            ...
                            %>
<td><%=it.getQuantity()%> <%=iu.getItemUnit(unit).getName()%>(s)</td>


<td><a href="" class="btn btn-success"><span class="fa fa-shopping-cart "> Add </span>  </a></td>
<td><a href="DetailedItemList.jsp?itemId=<%=it.getItemId()%>" class="btn btn-info"><span class="fa fa-bar-chart "> Details </span>  </a></td>
