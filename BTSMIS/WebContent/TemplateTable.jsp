        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="InStockList.jsp"><i class="fa fa-shopping-cart"></i> Available Items (<%=im.getAllPurchased().size() %>)</a>
                    </li>
            ...
            <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-brown">
                            <div class="panel-body">
                                ...
                                <h3><%=rm.getRequestSummary().size()%> </h3>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-blue">
                            ...
                            <a href="AllRequests.jsp" style="text-decoration: none" >
...
List<Request> list = rm.getRequestList();
for(Request it: list){
%>
...
<%
if(it.getStatus().equals("Request")){
%>

<td>  <a href="#" class="btn btn-info"> <span class="glyphicon glyphicon-book"></span> <%=it.getStatus() %></a></td> 

<%
}else if(it.getStatus().equals("Delivered")){
%>

<td>  <a href="#" class="btn btn-warning"> <span class="glyphicon glyphicon-clock"></span> <%=it.getStatus() %> but Not Confirmed</a></td> 
<%
}else if(it.getStatus().equals("Delivery Confirmed")){
%>
<td>  <a href="#" class="btn btn-success"> <span class="glyphicon glyphicon-ok"></span> <%=it.getStatus() %></a></td> 

<%
} else {
%>

<td>  <a href="#" class="btn btn-danger"> <span class="glyphicon glyphicon-remove"></span> <%=it.getStatus() %></a></td> 
<%} %>
                        </tr>
                        <%
                            }
