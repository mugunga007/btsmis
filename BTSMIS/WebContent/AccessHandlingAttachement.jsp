        ...
        <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                         <i class="fa fa-cogs text-success"></i>  <small>  Upload Reported Issue Attachement </small> 
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
...
<form class="form-horizontal" action="AccessHandlingAttchProcess.jsp" method="post" enctype="multipart/form-data">
