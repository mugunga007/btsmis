...
%>
                                        ...
                                        <span class="fa fa-2x active">Overall</span> <a class="glyphicon glyphicon-screenshot" href="ChartOnItem.jsp?itemId=<%=itemId%>">View on graph</a>
                                        &nbsp;&nbsp;    <a class="glyphicon glyphicon-screenshot" href="" data-toggle="modal" data-target="#myModal20">Fuel tracking</a>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                List<ItemReporting>k1=it.itemRemainingByOMAll(itemId);
                                             List<ItemReporting> l1=it.itemReportByOMAll(itemId);
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                List<ItemReporting>kp=it.itemRemainingByOMAll(itemId);
       ...
       <div class="form-group">
        ...
        <div class="modal-footer">
            <input type="submit" class="btn btn-default" value="Retrieve"></input>
               ...
               <form action="TrackFuelUsing.jsp">
