...
//String qid = request.getParameter("question");
      ...
      //  String k = "SELECT r.quantity,r.deliveredQuantity,r.requestDate FROM request r";
        String k = "SELECT SUM(ah.downtime),ar.btsId from accessHandling ah,accessRequest ar,bts bt WHERE ah.ticketId=ar.requestId  and bt.btsId=ar.btsId and ah.userId='"+userId+"' GROUP BY 2";
