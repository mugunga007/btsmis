               ...
               <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                         <i class="fa fa-dashboard text-success"></i>    <small>Downtime report</small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                List<TicketHandlingReports>k=th.downtimeByRegion(region);
...
<a href="DowntimeByRegionChart.jsp?regionId=<%=region%>" class="btn btn-link glyphicon glyphicon-link" >Click to view it on chart</a>
                                                      </div>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            <%
                                               // TicketHandlingReports th=new TicketHandlingReports();
                                                ...
                                                List<TicketHandlingReports>k1=th.downtimeInAllRegions();
                                           
          for(TicketHandlingReports w4:k1){
...
<a href="DowntimeChartAllRegions.jsp" class="btn btn-link glyphicon glyphicon-link" >Click to view it on chart</a>
                                                      </div>
                            </div>
                        </div>
