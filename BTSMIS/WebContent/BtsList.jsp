 ...
 User user = (User) session.getAttribute("user");
        ...
        <div class="row">
                    <div class="col-md-12">
                       ...
                       <i class="fa fa-list-ol text-success"></i>     <small>My Sites</small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
 ...
 <div class="panel panel-default">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tr>
                            ...
                            <th>LONGITUDE</th>
                            <th>MAP VIEW</th>
                            <th>REPORT ADDED/CURRENT FUEL</th>
                            <th>GEN QUANTITY</th>
                            <th>LAST UPDATE</th>
...
<% 
                            ...
                            List<Bts> list = btm.getBtsByEngineer(userId);
                            for (Bts it : list) {
                        %>                        
                        <tr>
  ...
  <td><%=it.getBtsId()%></td>
                            ...
                            <td><a class="btn btn-default" href="AddFuel.jsp?btsId=<%=it.getBtsId()%>"><i class="fa fa-edit"></i> Report Fuel</a></td> 
...
<td><%=gm.getGenSetByBts(it.getBtsId()).getLastUpdate() %></td>
 ...
 <td><a class="btn btn-default" href="GenSetFuelUsage.jsp?genSetId=<%=gm.getGenSetByBts(it.getBtsId()).getGenSetId() %>&&bid=<%=bid%>"><i class="fa fa-list-ul"></i> View Report </a></td>
 <td><a class="glyphicon glyphicon-eye-open" href="AccessRequestForm.jsp?BtsId=<%=it.getBtsId()%>">Open</a></td>
                        </tr>
                        <%
                            }
                        %>
