                                ...
                                <tbody>
                                    <%
                                      ...
                                      UserModel usm=new UserModel();
                                        List<ServiceRequest> k=thm.getAllSpecialTicketByRM(user.getRegion());
                                    ...
                                    <tr class="">
                                        ...
                                        %>
                                        <td><label class="active"><%=usm.getUser(it.getFengineerId()).getFname() %> <%=usm.getUser(it.getFengineerId()).getLname() %></label></td>
                                      </tr>
                                    <%
                                        i++;
                                        }
